(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@covalent/markdown'), require('@angular/material/button'), require('@angular/material/tooltip'), require('@angular/material/list'), require('@angular/material/icon'), require('@angular/material/progress-bar'), require('@covalent/flavored-markdown'), require('@angular/cdk/drag-drop'), require('@angular/material/toolbar'), require('@angular/core'), require('@angular/material/dialog'), require('@angular/cdk/overlay')) :
    typeof define === 'function' && define.amd ? define('@covalent/experimental/help', ['exports', '@angular/common', '@covalent/markdown', '@angular/material/button', '@angular/material/tooltip', '@angular/material/list', '@angular/material/icon', '@angular/material/progress-bar', '@covalent/flavored-markdown', '@angular/cdk/drag-drop', '@angular/material/toolbar', '@angular/core', '@angular/material/dialog', '@angular/cdk/overlay'], factory) :
    (factory((global.covalent = global.covalent || {}, global.covalent.experimental = global.covalent.experimental || {}, global.covalent.experimental.help = {}),global.ng.common,global.markdown,global.ng.material.button,global.ng.material.tooltip,global.ng.material.list,global.ng.material.icon,global.ng.material['progress-bar'],global.flavoredMarkdown,global.ng.cdk['drag-drop'],global.ng.material.toolbar,global.ng.core,global.ng.material.dialog,global.ng.cdk.overlay));
}(this, (function (exports,common,markdown,button,tooltip,list,icon,progressBar,flavoredMarkdown,dragDrop,toolbar,i0,i1,i2) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var DraggableHelpWindowDialogComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        DraggableHelpWindowDialogComponent.ctorParameters = function () {
            return [
    ...
    var DraggableHelpWindowDialogService = /** @class */ (function () {
        ...
        /** @nocollapse */
        DraggableHelpWindowDialogService.ctorParameters = function () {
            return [
                { type: i1.MatDialog },
                { type: i2.Overlay }
            ];
        };
        /** @nocollapse */ DraggableHelpWindowDialogService.ngInjectableDef = i0.defineInjectable({ factory: function DraggableHelpWindowDialogService_Factory() { return new DraggableHelpWindowDialogService(i0.inject(i1.MatDialog), i0.inject(i2.Overlay)); }, token: DraggableHelpWindowDialogService, providedIn: CovalentHelpModule });
