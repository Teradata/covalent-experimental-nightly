(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@covalent/core/breadcrumbs'), require('@covalent/core/tab-select'), require('@angular/router'), require('rxjs'), require('rxjs/operators'), require('@covalent/core/common'), require('@angular/material/icon'), require('@angular/material/core'), require('@angular/cdk/portal'), require('@covalent/http')) :
    typeof define === 'function' && define.amd ? define('@covalent/experimental', ['exports', '@angular/core', '@angular/common', '@covalent/core/breadcrumbs', '@covalent/core/tab-select', '@angular/router', 'rxjs', 'rxjs/operators', '@covalent/core/common', '@angular/material/icon', '@angular/material/core', '@angular/cdk/portal', '@covalent/http'], factory) :
    (factory((global.covalent = global.covalent || {}, global.covalent.experimental = {}),global.ng.core,global.ng.common,global.covalent.core.breadcrumbs,global.covalent.core['tab-select'],global.ng.router,global.rxjs,global.rxjs.operators,global.covalent.core.common,global.ng.material.icon,global.ng.material.core,global.ng.cdk.portal,global.covalent.http));
}(this, (function (exports,core,common,breadcrumbs,tabSelect,router,rxjs,operators,common$1,icon,core$1,portal,http) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    exports.httpFactory = http.httpFactory;
    exports.HTTP_CONFIG = http.HTTP_CONFIG;
    exports.HTTP_INTERCEPTOR_PROVIDER = http.HTTP_INTERCEPTOR_PROVIDER;
    exports.CovalentHttpModule = http.CovalentHttpModule;
    exports.TdURLRegExpInterceptorMatcher = http.TdURLRegExpInterceptorMatcher;
    exports.TdHttpService = http.TdHttpService;
    exports.TdGET = http.TdGET;
    exports.TdPOST = http.TdPOST;
    exports.TdPATCH = http.TdPATCH;
    exports.TdPUT = http.TdPUT;
    exports.TdDELETE = http.TdDELETE;
    exports.TdHttp = http.TdHttp;
    exports.TdHttpClient = http.TdHttpClient;
    exports.TdParam = http.TdParam;
    exports.TdBody = http.TdBody;
    exports.TdResponse = http.TdResponse;
    exports.TdQueryParams = http.TdQueryParams;
    exports.mixinHttp = http.mixinHttp;
